...
st.markdown("""
<style>
    /* Fondo principal AUTÉNTICO plomo oscuro (gris azulado) */
    .stApp, .main .block-container, body {
        background-color: #2C3539 !important;  /* Gris acero oscuro */
    }
    ...
    /* Panel de descripción - Gris medio */
    .description-panel {
        background-color: #36454F !important;  /* Carbón */
        border-left: 5px solid #1E88E5;
    }
    
    /* Sliders - Tonos grises */
    .stSlider .track {
        background-color: #546E7A !important;  /* Gris azulado */
    }
    
    /* Pestañas */
    .stTabs [data-baseweb="tab"] {
        background-color: #3E4E55 !important;  /* Gris plomo */
    }
