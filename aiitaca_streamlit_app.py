...
<style>
    ...
    /* === NUEVOS ESTILOS PARA EL FILE UPLOADER (FONDO CLARO) === */
    .stFileUploader>div>div>div>div {
        background-color: #F5F5F5 !important;  /* Gris claro */
        border: 1px solid #B0B0B0 !important;  /* Borde gris */
    ...
    .stFileUploader>div>div>div>div:hover {
        background-color: #E0E0E0 !important;  /* Gris un poco más oscuro */
        border-color: #909090 !important;
    }
    /* Estilo para el texto "Drag and drop file here..." */
    .stFileUploader>div>section>div>div>div>span {
        color: #000000 !important;  /* Texto negro */
        font-size: 14px !important;
    }
    /* Estilo para el botón "Browse Files" */
    .stFileUploader>div>section>div>button {
        background-color: #1E88E5 !important;  /* Azul (como tus otros botones) */
        color: white !important;
    ...
    /* NUEVO ESTILO AÑADIDO - Color del texto del botón */
...
top_n_similar = st.sidebar.slider("Top N Similar", 50, 2000, 100, step=50)
