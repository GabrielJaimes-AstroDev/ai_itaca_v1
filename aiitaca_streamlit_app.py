...
<style>
    ...
    .stApp, .main .block-container, body {
        background-color: #2F4F4F !important;  /* Color plomo oscuro */
    }
    ...
    .description-panel {
        text-align: justify;
        background-color: #3A5F5F !important;  /* Tono más claro que el fondo */
        color: #FFFFFF !important;
        padding: 20px;
        border-radius: 10px;
    ...
    .description-panel strong {
        color: #B0E0E6 !important;  /* Azul claro para énfasis */
    }
    ...
    .stTabs [data-baseweb="tab"] {
        ...
        padding: 0 20px;
        color: #FFFFFF !important;
        background-color: #3A5F5F !important;  /* Tono intermedio */
    ...
    .stFileUploader>div>div>div>div {
        background-color: #3A5F5F !important;
    ...
    .stFileUploader>div>div>div>div:hover {
        background-color: #4F7F7F !important;
