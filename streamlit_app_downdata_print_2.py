                ...
                with st.spinner("Analyzing spectrum..."):
                    ...
                    if not os.path.exists(data_file):
                        ...
                        tab1, tab2, tab3, tab4, tab5 = st.tabs([
                            "Molecule Best Match", 
                            "Peak Matching", 
                            "CNN Training: LogN vs Similarity and Euclidean Distance", 
                            "Top Selection: LogN vs Similarity and Euclidean Distance", 
                            "Top Selection: Tex vs Similarity and Euclidean Distance"
                        ])
