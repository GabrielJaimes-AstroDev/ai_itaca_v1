        ...
        if params_tab:
            with st.container():
                ...
                <div class="info-panel">
                    <h3 style="color: black; text-align: center; margin-bottom: 20px;">Parameters Explanation</h3>
                    
                    <div style="margin-bottom: 25px;">
                        <h4 style="color: #1E88E5; border-bottom: 1px solid #eee; padding-bottom: 5px;">Peak Detection</h4>
                        <p><b>Sigma Emission (1.5):</b> Sensitivity for emission peak detection</p>
                        <p><b>Window Size (3):</b> Smoothing window size in channels</p>
                        <p><b>Sigma Threshold (2.0):</b> Minimum significance level for peaks</p>
                        <p><b>FWHM (0.05 GHz):</b> Expected line width</p>
                    </div>
                    
                    <div style="margin-bottom: 25px;">
                        <h4 style="color: #1E88E5; border-bottom: 1px solid #eee; padding-bottom: 5px;">Matching</h4>
                        <p><b>Tolerance (0.1 GHz):</b> Max frequency difference for matching</p>
                        <p><b>Min Peak Ratio (0.3):</b> Minimum relative peak height</p>
                    </div>
                    
                    <div>
                        <h4 style="color: #1E88E5; border-bottom: 1px solid #eee; padding-bottom: 5px;">Output</h4>
                        <p><b>Top N Lines (30):</b> Strongest lines to display</p>
                        <p><b>Top N Similar (800):</b> Similar spectra to consider</p>
                    </div>
                </div>
                """, unsafe_allow_html=True)
