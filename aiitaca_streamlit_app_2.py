...
@st.cache_resource(show_spinner="Loading training data...")
            ...
            try:
                ...
                if not os.path.exists(data_file):
                    ...
                    results = analyze_spectrum(
                        tmp_path, model, training_data['train_data'], training_data['train_freq'],
                        training_data['filenames'], training_data['headers'], 
                        training_data['train_logn'], training_data['train_tex'],
                        config, mol_name
                    )
