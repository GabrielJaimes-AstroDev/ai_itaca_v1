        ...
        if params_tab:
            with st.container():
                ...
                <div class="info-panel">
                    <h3 style="color: black; border-bottom: 2px solid black; padding-bottom: 10px;">Parameters Explanation</h3>
                    
                    <h4 style="color: black; margin-top: 20px;">Peak Detection Parameters</h4>
                    <p><strong>Sigma Emission:</strong> Controls the sensitivity for detecting emission peaks. Higher values make the detection less sensitive to noise.</p>
                    <p><strong>Window Size:</strong> Size of the smoothing window applied to the spectrum before peak detection (in channels).</p>
                    <p><strong>Sigma Threshold:</strong> Minimum significance level for detected peaks (in standard deviations).</p>
                    <p><strong>FWHM (GHz):</strong> Expected full width at half maximum of spectral lines (helps in line identification).</p>
                    
                    <h4 style="color: black; margin-top: 20px;">Matching Parameters</h4>
                    <p><strong>Tolerance (GHz):</strong> Maximum frequency difference allowed when matching observed peaks to theoretical lines.</p>
                    <p><strong>Min Peak Height Ratio:</strong> Minimum relative height (compared to strongest peak) for a peak to be considered.</p>
                    
                    <h4 style="color: black; margin-top: 20px;">Output Parameters</h4>
                    <p><strong>Top N Lines:</strong> Number of strongest lines to show in the detailed matching results.</p>
                    <p><strong>Top N Similar:</strong> Number of most similar synthetic spectra to consider in the analysis.</p>
                </div>
                """, unsafe_allow_html=True)
