...
<style>
    ...
    /* Nuevos estilos para las pestañas de información */
    .info-tab {
        background-color: white !important;
        color: black !important;
...
if input_file is not None:
    ...
    if not model_files:
        ...
        # Mostrar el panel de explicación de parámetros si se hace clic
        if params_tab:
            with st.container():
                st.markdown("""
                <div class="info-panel">
                    <h3 style="color: black; border-bottom: 2px solid black; padding-bottom: 10px; text-align: center;">Parameters Explanation</h3>
                    
                    <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
                        <tr>
                            <th colspan="3" style="background-color: #1E88E5; color: white; padding: 10px; text-align: left;">Peak Detection Parameters</th>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px; width: 25%;"><strong>Sigma Emission</strong></td>
                            <td style="border: 1px solid #ddd; padding: 8px; width: 15%;">1.5</td>
                            <td style="border: 1px solid #ddd; padding: 8px; width: 60%;">Controls the sensitivity for detecting emission peaks. Higher values make the detection less sensitive to noise.</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>Window Size</strong></td>
                            <td style="border: 1px solid #ddd; padding: 8px;">3</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Size of the smoothing window (in channels) applied to the spectrum before peak detection.</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>Sigma Threshold</strong></td>
                            <td style="border: 1px solid #ddd; padding: 8px;">2.0</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Minimum significance level (in standard deviations) for detected peaks to be considered.</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>FWHM (GHz)</strong></td>
                            <td style="border: 1px solid #ddd; padding: 8px;">0.05</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Expected full width at half maximum of spectral lines, helps in line identification.</td>
                        </tr>
                        
                        <tr>
                            <th colspan="3" style="background-color: #1E88E5; color: white; padding: 10px; text-align: left; margin-top: 20px;">Matching Parameters</th>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>Tolerance (GHz)</strong></td>
                            <td style="border: 1px solid #ddd; padding: 8px;">0.1</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Maximum frequency difference allowed when matching observed peaks to theoretical lines.</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>Min Peak Height Ratio</strong></td>
                            <td style="border: 1px solid #ddd; padding: 8px;">0.3</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Minimum relative height (compared to strongest peak) for a peak to be considered.</td>
                        </tr>
                        
                        <tr>
                            <th colspan="3" style="background-color: #1E88E5; color: white; padding: 10px; text-align: left;">Output Parameters</th>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>Top N Lines</strong></td>
                            <td style="border: 1px solid #ddd; padding: 8px;">30</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Number of strongest lines to show in the detailed matching results.</td>
                        </tr>
                        <tr>
                            <td style="border: 1px solid #ddd; padding: 8px;"><strong>Top N Similar</strong></td>
                            <td style="border: 1px solid #ddd; padding: 8px;">800</td>
                            <td style="border: 1px solid #ddd; padding: 8px;">Number of most similar synthetic spectra to consider in the analysis.</td>
                        </tr>
                    </table>
                    
                    <div style="margin-top: 20px; padding: 10px; background-color: #f8f9fa; border-left: 4px solid #1E88E5;">
                        <p style="margin: 0; font-style: italic;">Note: The values shown are the default parameters. Adjust them in the sidebar as needed for your analysis.</p>
                    </div>
                </div>
                """, unsafe_allow_html=True)
        ...
        if flow_tab:
            with st.container():
                st.markdown("""
                <div class="info-panel">
                    <h3 style="color: black; border-bottom: 2px solid black; padding-bottom: 10px;">Flow of Work Diagram</h3>
                    <div style="text-align: center;">
                        <img src="Flow_of_work.jpg" style="max-width: 100%; height: auto; border: 1px solid #ddd; border-radius: 4px;">
                    </div>
                    <p style="margin-top: 15px; text-align: center;"><em>The workflow diagram shows the complete analysis process from spectrum input to final results.</em></p>
                </div>
                """, unsafe_allow_html=True)
