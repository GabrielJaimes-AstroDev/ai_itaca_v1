        ...
        if params_tab:
            with st.container():
                ...
                <div class="description-panel">
                    <h3 style="text-align: center; margin-top: 0; color: black;">Parameters Explanation</h3>
                    
                    <div style="margin-bottom: 25px;">
                        <h4 style="color: #1E88E5; border-bottom: 1px solid #ddd; padding-bottom: 5px;">Peak Detection</h4>
                        <p><strong>Sigma Emission (1.5):</strong> Controls the sensitivity for detecting emission peaks</p>
                        <p><strong>Window Size (3):</strong> Size of the smoothing window in channels</p>
                        <p><strong>Sigma Threshold (2.0):</strong> Minimum significance level for peaks</p>
                        <p><strong>FWHM (0.05 GHz):</strong> Expected line width for identification</p>
                    </div>
                    
                    <div style="margin-bottom: 25px;">
                        <h4 style="color: #1E88E5; border-bottom: 1px solid #ddd; padding-bottom: 5px;">Matching Parameters</h4>
                        <p><strong>Tolerance (0.1 GHz):</strong> Max frequency difference for matching</p>
                        <p><strong>Min Peak Ratio (0.3):</strong> Minimum relative peak height</p>
                    </div>
                    
                    <div>
                        <h4 style="color: #1E88E5; border-bottom: 1px solid #ddd; padding-bottom: 5px;">Output Settings</h4>
                        <p><strong>Top N Lines (30):</strong> Number of strongest lines to display</p>
                        <p><strong>Top N Similar (800):</strong> Similar spectra to consider</p>
                    </div>
                </div>
                """, unsafe_allow_html=True)
